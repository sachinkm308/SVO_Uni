...
if("TRUE" STREQUAL "TRUE")
  set(realsense2_camera_SOURCE_PREFIX /home/nvidia/catkin_ws/src/realsense-ros/realsense2_camera)
...
if(NOT "/home/nvidia/catkin_ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'realsense2_camera' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/catkin_ws/src/realsense-ros/realsense2_camera/${idir}'.  ${_report}")
    endif()
